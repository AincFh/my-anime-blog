      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="glass-card-deep tech-border rounded-2xl p-6">
            <h2 className="text-xl font-bold text-white mb-6">🏷️ 标签云</h2>
          ...
          {/* 分类树 */}
          <div className="glass-card-deep tech-border rounded-2xl p-6">
            <h2 className="text-xl font-bold text-white mb-6">📚 分类树</h2>
            <div className="space-y-2">
              {categories.map((category) => (
                <motion.div
                  key={category.id}
                  className="flex items-center justify-between p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-colors cursor-move"
                  whileHover={{ x: 4 }}
                >
                  ...
                  <span className="text-xs text-white/40">拖拽排序</span>
                </motion.div>
              ))}
            </div>
          </div>

...
export async function loader({ request, context }: { request: Request; context: any }) {
    ...
    if (!valid || !user) {
        return { loggedIn: false, user: null, stats: { coins: 0 }, inventory: [] };
    }
                            ...
                            {filteredInventory.length > 0 ? (
                                <div className="grid grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-4">
                                    ...
                                    `}
                                            ...
                                            whileTap={{ scale: 0.95 }}
                                        >
                                            <img src={item.image_url} alt={item.name} className="w-full h-full object-cover p-2" />
                                ...
                                >
                                    <div className="aspect-square bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border border-white/10 flex items-center justify-center mb-6 relative overflow-hidden group">
                                        ...
                                        <motion.img
                                            ...
                                            className="w-3/4 h-3/4 object-contain z-10 drop-shadow-2xl"

                    ...
                    <div className="relative z-10">
                        ...
                        <div className="mt-8 text-center space-y-4">
                            ...
                            <div className="flex justify-center gap-4">
                                {/* 第三方登录占位符 - 可以封装为组件 */}
                                <button className="p-2 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
